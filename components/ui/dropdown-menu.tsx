...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      // Base UI's Menu.Item renders a <div> (NonNativeButtonProps, @default
      // false) — so an item WITHOUT a `render` prop is not a native button
      // either. Deriving this from `!props.render` claimed the opposite and
      // logged "a component that acts as a button was not rendered as a native
      // <button>" every time a plain menu opened. Pass `nativeButton` yourself
      // only when you render a real <button/>.
